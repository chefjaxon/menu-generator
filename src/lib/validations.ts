...
const swapSchema = z.object({
  ...
  substituteQty: z.string().max(100).optional().nullable(),
  substituteUnit: z.string().max(50).optional().nullable(),
});
...
export const clientCreateSchema = z.object({
  ...
  chefNotes: z.string().optional().default(''),
  servingsPerDish: z.number().int().min(1).max(20).optional(),
  dishCount: z.number().int().min(1).max(20).optional(),
